    ...
    <div class="reg__section">
      ...
      <div class="reg-form">
        ...
        <v-stepper v-model="e1">
          <v-stepper-header>
            <v-stepper-step step="1" color="#C7493A" :complete="e1 > 1">
              Основная <small>информация</small>
            </v-stepper-step>

            <v-divider></v-divider>

            <v-stepper-step step="2" color="#C7493A" :complete="e1 > 2">
              Контактные <small>данные</small>
            </v-stepper-step>

            <v-divider></v-divider>

            <v-stepper-step step="3" color="#C7493A"> Завершение </v-stepper-step>
          </v-stepper-header>
          ...
          <v-stepper-items>
            <v-stepper-content step="1">
              ...
              <div class="reg__optional">
                <v-btn color="#FFF" width="190" height="52" outlined text to="/main"> Назад </v-btn>

                <v-btn width="190" height="52" outlined color="#C7493A" @click="e1 = 2"> Следующий шаг </v-btn>
              </div>
            </v-stepper-content>
            ...
            <v-stepper-content step="2">
              <v-card>
                ...
                <v-form>
                  ...
                  <div class="reg__form-radio">
                    <v-radio-group v-model="radios" row mandatory label="Ваш пол">
                      <v-radio label="Мужской" value="man" color="#C7493A"></v-radio>

                      <v-radio label="Женский" value="women" color="#C7493A"></v-radio>
                    </v-radio-group>
                  </div>
                </v-form>
              </v-card>
              ...
              <div class="reg__optional">
                <v-btn color="#FFF" width="190" height="52" outlined text @click="e1 = 1"> Назад </v-btn>

                <v-btn width="190" height="52" outlined color="#C7493A" @click="e1 = 3"> Следующий шаг </v-btn>
              </div>
            </v-stepper-content>

            <v-stepper-content step="3">
              <v-card class="mb-n12" color="110F0F" height="561px">
                <h3 class="reg__form-title">ДАННЫЕ ДЛЯ РЕГИСТРАЦИИ</h3>
              </v-card>

              <div class="reg__optional">
                <v-btn width="190" height="52" outlined text @click="e1 = 2"> Назад </v-btn>

                <v-btn width="190" height="52" outlined color="#C7493A" @click="e1 = 1"> Завершить </v-btn>
              </div>
            </v-stepper-content>
          </v-stepper-items>
        </v-stepper>
...
export default {
  ...
  methods: {
    customFilter(item: { name: string; abbr: string }, queryText: string, itemText: any) {
